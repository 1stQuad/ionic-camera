...
- (void)setupView
{
    ...
    [self.viewController presentViewController:vc animated:YES completion:^{
        ...
        self.takedPhoto = [[UIImageView alloc] init];
        self.takedPhoto.frame = self.viewController.view.frame;
        [self.previewView addSubview:self.takedPhoto];
        self.spinner = [[UIActivityIndicatorView alloc]initWithFrame:CGRectMake(0,0,50,50)];
        self.spinner.translatesAutoresizingMaskIntoConstraints = NO;
        [self.takedPhoto addSubview:self.spinner];
        NSLayoutConstraint *xSpinCenterConstraint = [NSLayoutConstraint constraintWithItem:self.spinner attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.takedPhoto attribute:NSLayoutAttributeCenterX multiplier:1.0 constant:0];
        [self.takedPhoto addConstraint:xSpinCenterConstraint];
        NSLayoutConstraint *ySpinCenterConstraint = [NSLayoutConstraint constraintWithItem:self.spinner attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.takedPhoto attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0];
        [self.takedPhoto addConstraint:ySpinCenterConstraint];
        self.spinner.hidden = YES;
...
//        UINavigationBar *myNav = [[UINavigationBar alloc]initWithFrame:CGRectMake(0, 0, 320, 55)];
        ...
        [self.previewView addSubview:myNav];
